...
export function InspirationContent({ mode = "page" }: { mode?: "page" | "modal" }) {
  ...
  const items = [
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/karpathy"
          alt="Andrej Karpathy"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/waitin4agi_"
          alt="Varun"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/kirat_tw"
          alt="Kirat"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/AnshMehraaa"
          alt="Ansh Mehra"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/SolanaFndn"
    ...
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/usagimaruma"
          alt="usagimaruma"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/fchollet"
    ...
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/jeremyphoward"
          alt="Jeremy Howard"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/yenling_kuo"
          alt="Yen-Ling Kuo"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/RLanceMartin"
          alt="Lance Martin"
          className="size-full"
        />
      ),
    },
    {
      ...
      src: (
        <img
          src="https://unavatar.io/x/claudeai"
          alt="Claude AI"
          className="size-full"
        />
      ),
    },
    {
      ...
      href: "https://nav.al",
      src: <img src="/inspiration/naval.jpg" alt="Naval" className="size-full" />,
    },
  ];
  ...
  const goBack = () => {
    ...
    // Use same root transition CSS as theme toggle.
    ...
    <div className="no-plus-cursor">
      {mode === "page" && (
        <div className="fixed top-4 left-4 z-[999]">
          <BackIconButton
            onClick={goBack}
            viewTransitionName="inspiration-back"
            ariaLabel="Back"
          />
        </div>
      )}
      <Container className={mode === "page" ? "min-h-screen" : ""}>
